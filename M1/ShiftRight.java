...
// FILL IN THE BODY OF THIS METHOD
        /*
            Idea to solve this problem is Every time we shift the array right by one position and the arrya will be shifted based on the index
            Ex: arr = [1, 2, 3, 4, 5, 6]
            if we call shiftRight(arr,2)
            we just rightShift the arr of from 2nd index so we just shift [3,4,5,6] by one position to right so the output is
            [1,2,6,3,4,5]
         */
...
//ArrayShiftQuestion.java

import java.util.Arrays;


public class ArrayShiftQuestion {
